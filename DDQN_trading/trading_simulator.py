...
class TradingSimulator:
    ...
    def take_step(self, action: int, market_return: float) -> tuple:
        ...
        end_position = action - 1  # short, neutral, long              # to understand
        n_trades = end_position - start_position                       # to understand
        self.positions[self.step] = end_position                       # to understand
        self.trades[self.step] = n_trades                              # to understand
